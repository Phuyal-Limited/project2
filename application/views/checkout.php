				...
				<div class="checkout-content"><!-- starts:checkout content-->
					...
					<div class="row">
						...
						<form name="Form" action="https://mms.paymentsensegateway.com/Pages/PublicPages/PaymentForm.aspx" method="post" >
			                  ...
			                  <input type="hidden" name="ServerResultURL" value="<?php echo base_url('thank_you'); ?>" />
			                  <input type="hidden" name="PaymentFormDisplaysResult" value="<?php echo base_url('thank_you'); ?>" />
									...
									<div class='detail-content'>
										...
										<div class="row"> <!-- starts:form-row -->
											...
											<div class="col-md-6 col-sm-6 col-xs-8">
												<input class='form-control' id="CustomerName" type="text" placeholder="Full Name Here" name="CustomerName" required>
											</div>
										</div> <!-- starts:form-row -->
