								...
								<div class='detail-content'>
									...
									<div class="row"> <!-- starts:form-row -->
										...
										<div class="col-md-6 col-sm-6 col-xs-8">
											<input class='form-control' type="text" placeholder="Full Name Here" name="name" required>
										</div>
									</div> <!-- starts:form-row -->
									...
									<div class="row">
										...
										<div class="col-md-6 col-sm-6 col-xs-8">
											<input class='form-control' type="text" placeholder="For Non Nepalese Guest" name="pasport" required>
										</div>
									</div>
									<div class="clear"></div> <!-- clears some field below form-row -->
									<div class="row">
									...
									<div class="col-md-12">
										<div class="form-footer">
											...
											<div class="clear-small"></div>
											<input class="btn btn-detault inn-button" type="submit" value="Continue Payment">
										</div>
									</div>
									<div class="clear"></div> <!-- clears some field below form-row -->
								</div>
